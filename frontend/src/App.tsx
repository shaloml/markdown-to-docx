...
המערכת צריכה לטפל נכון בטקסט עברי, כולל את הדברים הבאים:
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              ...
              {/* GitHub Link */}
              <a
                href="https://github.com/shaloml/markdown-to-docx"
                target="_blank"
                rel="noopener noreferrer"
                className={`p-2 rounded-lg transition-all ${isDark ? 'bg-white/10 hover:bg-white/20 text-white' : 'bg-gray-200 hover:bg-gray-300 text-gray-600'}`}
                title="קוד מקור ב-GitHub"
              >
